define(["dojo/_base/declare",
    ...
    return declare(null, {
        ...
        postRequest: function(service, parameter, header, data){
            var request = this._buildRequestUrl(service, parameter);
            return this._xhrRequest(request, header, "POST", data);
        },

        putRequest: function(service, parameter, header, data){
            var request = this._buildRequestUrl(service, parameter);
            return this._xhrRequest(request, header, "PUT", data);
        },
        ...
        _xhrRequest: function(request, header, method, data){
            if(!header) header = {};
