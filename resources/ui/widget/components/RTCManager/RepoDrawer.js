define(["dojo/_base/declare",
    ...
    return declare(null, {
        ...
        _noRepos: function(){
            this._createRepoLabel("No Git Repositories Registered.");
            this._createHelpPanel();
        },

        _createHelpPanel: function(){
            var supporLink = "https://wiki.siemens.com/x/8uJsB";
            var content = domConstruct.create("div", {}, this.rootDiv);
            domConstruct.create("a", {href:supporLink, innerHTML:"How to use 'Git Commit Picker'", target:"_blank" }, content);
        ...
        _createGitLabDescription: function(ul){
            ...
            domConstruct.create("li", {innerHTML: "Git Side:"}, ul);
        ...
        _createRTCDescription: function(ul){
            ...
            var list = domConstruct.create("ul", {}, ul);
            domConstruct.create("li", {innerHTML: "You need to register a git repository."}, list);
            var test = domConstruct.create("li", {}, list);
            domConstruct.create("a", {href:rtcGitOverview, innerHTML:"Git Repositories", target:"_blank" }, test);
            domConstruct.create("li", {innerHTML: "Needed information:"}, list);
            domConstruct.create("li", {innerHTML: "1: Url to Git repository"}, list);
            domConstruct.create("li", {innerHTML: "2: Access Token"}, list);
            domConstruct.create("li", {innerHTML: "3: Name the repository"}, list);
        },

        _multipleRepos: function(){
            this._createRepoLabel("Please Select A Git Repository");
            ...
            this.repoButton = domConstruct.create("button", {innerHTML: "Select Repository", className: "primary-button"}, this.rootDiv);
        },
